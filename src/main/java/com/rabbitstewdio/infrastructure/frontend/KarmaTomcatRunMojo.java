...
public final class KarmaTomcatRunMojo extends TomcatSupportMojoBase {
  ...
  public void execute() throws MojoExecutionException, MojoFailureException {
    try {
      ...
      if (skipTests) {
        LoggerFactory.getLogger(KarmaTomcatRunMojo.class).info("Skipping karma tests.");
      } else {
      ...
      if (testFailureIgnore) {
        LoggerFactory.getLogger(KarmaTomcatRunMojo.class).warn("There are ignored test failures/errors for: " + workingDirectory);
      } else {
